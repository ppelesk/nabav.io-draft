...
export default function rashodovana_imovina_page({ imovina }: { imovina: Imovina[] }) {
    const handleExport = () => {
        window.open(`/izvjestaji/rashodovana-imovina?pdf=true`, '_blank');
    };
    ...
    return (
        <>
            <Head title="Izvještaj o rashodovanoj imovini" />
            <div className="space-y-6 p-4">
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <Heading
                        title="Izvještaj o rashodovanoj imovini"
                        description="Popis rashodovane imovine sa statusima i lokacijom"
                    />
                    <Button onClick={handleExport}>Preuzmi PDF</Button>
                </div>
                <Card>
                    <CardHeader>
                        <CardTitle>Popis rashodovane imovine</CardTitle>
                    </CardHeader>
                    <CardContent>
...
rashodovana_imovina_page.layout = {
    breadcrumbs: [
