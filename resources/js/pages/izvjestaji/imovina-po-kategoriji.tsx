...
export default function imovina_po_kategoriji_page({ imovina }: { imovina: Imovina[] }) {
    const handleExport = () => {
        window.open(`/izvjestaji/imovina-po-kategoriji?pdf=true`, '_blank');
    };
    ...
    return (
        <>
            <Head title="Izvještaj o imovini po kategoriji" />
            <div className="space-y-6 p-4">
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <Heading
                        title="Izvještaj o imovini po kategoriji"
                        description="Pregled stavki razvrstanih po kategorijama"
                    />
                    <Button onClick={handleExport}>Preuzmi PDF</Button>
                </div>
                <Card>
                    <CardHeader>
                        <CardTitle>Popis imovine po kategorijama</CardTitle>
                    </CardHeader>
                    <CardContent>
...
imovina_po_kategoriji_page.layout = {
    breadcrumbs: [
