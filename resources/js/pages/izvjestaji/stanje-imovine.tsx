...
export default function stanje_imovine_page({ imovina }: { imovina: Imovina[] }) {
    const handleExport = () => {
        window.open(`/izvjestaji/stanje-imovine?pdf=true`, '_blank');
    };
    ...
    return (
        <>
            <Head title="Izvještaj o stanju imovine" />
            <div className="space-y-6 p-4">
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <Heading
                        title="Izvještaj o stanju imovine"
                        description="Detaljan prikaz trenutnog stanja imovine"
                    />
