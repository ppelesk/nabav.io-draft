...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('audit_log', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('id_statusa_loga');
        ...
        DB::table('statusi_loga')->insert([
            [
                'sifra_statusa' => 'uspjeh',
                'naziv_statusa' => 'Uspjeh',
                'created_at' => $now,
                'updated_at' => $now,
            ],
            [
                'sifra_statusa' => 'neuspjeh',
                'naziv_statusa' => 'Neuspjeh',
                'created_at' => $now,
                'updated_at' => $now,
            ],
        ]);
